// source: https://github.com/MaiaVictor/eth-lib.git
...
var Keccak = function (bits) { return ({
    blocks: [],
    reset: true,
    block: 0,
    start: 0,
...
var update = function (state, message) {
...
var keccak = function (bits) { return function (str) {
    var msg;
    if (str.slice(0, 2) === "0x") {
        msg = [];
